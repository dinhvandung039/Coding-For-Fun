...
namespace FacadePattern
{
    public class DailyReporter
    {
        ...
        private readonly ISendEmail _emailer = new Emailer(new ConsoleLogger());
        private readonly IDatabase _database = new Database("connection string", new ConsoleLogger());
        ...
        public IAmqpQueue Queue => _queue;
